...
module.exports = class User {
  ...
  destroy() {
    ...
    static create(data){
        ...
        const usernameExistsTest = await db.query(
        ...
        let userData = await db.query(
          `
                INSERT INTO users (name,username,email,password,create_date) VALUES ($1, $2, $3, $4, $5) RETURNING *;`,
          [name, username, email, password, create_date]
        );
